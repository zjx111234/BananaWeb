...
urlpatterns = [
    ...
    url(r'^user_short_articles/(\d+)$', views.user_short_articles, name="user_short_articles"),
    url(r'^user_comment/(\d+)$', views.user_comment, name="user_comment"),
    url(r'^user_draft/(\d+)$', views.user_draft, name="user_draft"),
    url(r'^user_short_draft/(\d+)$', views.user_short_draft, name="user_short_draft"),
    url(r'^user_draft/del_draft/(\d+)$', views.del_draft, name="del_draft"),
    url(r'^user_short_draft/del_short_draft/(\d+)$', views.del_short_draft, name="del_short_draft"),
    url(r'^user_like_article/(\d+)$', views.user_like_article, name="user_like_article"),
    url(r'^like_short_articles/(\d+)$', views.user_like_short_articles, name="like_short_articles"),
    url(r'^user_detail/(\d+)$', views.user_comment_reply, name="user_detail"),
    url(r'^modify_draft/(\d+)$', views.modify_draft, name="modify_draft"),
    url(r'^modify_short_draft/(\d+)$', views.modify_short_draft, name="modify_short_draft"),
