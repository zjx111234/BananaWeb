...
urlpatterns = [
    ...
    url(r'^new_short_article/$', views.new_short_article, name="new_short_article"),
    url(r'^get_more_short_articles/$', views.get_more_short_articles, name="get_more_short_articles"),
    ...
    url(r'^short_article_add_favor/$', views.short_article_add_favor, name="short_article_add_favor"),
